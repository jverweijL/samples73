...
<div class="d-flex flex-column min-vh-100">
	...
	<div class="d-flex flex-column flex-fill" id="wrapper" style="background-image: url('${images_folder}/custom/aegon-bg.jpg');  background-size: 100%; background-repeat: no-repeat;">
		<#if show_header>
			<header id="banner">
		...
		<section class="${portal_content_css_class} flex-d flex-fill" id="content">
