...
<div class="d-flex flex-column min-vh-100">
	...
	<div class="d-flex flex-column flex-fill" id="wrapper" style="background-image: url('${images_folder}/custom/header3.png');  background-size: 100%; background-repeat: no-repeat;">
		<#if show_header>
			<header id="banner">
